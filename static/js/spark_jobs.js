$(document).ready(() => {
  $.getJSON('/get_users_services/sparkjob', (data) => {
    console.log('running jobs: ', data);
    let table = $('#services_table').DataTable({
      data: data,
      "paging": false,
      "searching": false,
      "aoColumns": [
  ...
  $.getJSON('/get_services_from_es/sparkjob', (data) => {
    console.log('from es:', data);
    let table = $('#services_table_es').DataTable({
      data: data,
      "paging": false,
      "searching": false,
      "aoColumns": [
